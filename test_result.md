...
agent_communication:
  - agent: "main"
    message: "Corrections implémentées selon spécifications : 1) Système chance de récolte corrigé pour calculer dynamiquement N blé de base (Math.floor de la chance) + % pour le suivant, 2) Nouveaux paliers terrain mis à jour (5, 15, 30, 75, 150, 300, 500, 1000, 2000), 3) FULL_HARVEST_SKILL maintenant affiché dans améliorations avec mise à jour automatique, 4) Récolte automatique refactorisée : AUTO_HARVEST_CHANCE utilise système comme chance normale, AUTO_HARVEST_SPEED basé sur totalAutoHarvested avec paliers corrects, 5) Affichage unifié dans une seule amélioration. Prêt pour tests complets."